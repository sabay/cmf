        ...
        <body class="hidemenu">
            <div class="page">
                <div class="header">
                    ...
                    <a href="../../" id="logo"><img alt="" src="{/page/root}/i/adm/adlabs.png" /></a>
                    <div class="main"></div>
                </div>
                ...
                <div class="wrap">
                    <div class="content">
                        <div class="lining center">
                            <form action="{/page/root}/login/" method="POST" class="login">
                                    ...
                                    <tr>
                                        <td class="l85">
                                            <div class="neg">
                                                ...
                                                <a href="javascript:void(0);" onclick="$(this).parents('form:first').submit();" name="ev">Войти</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
